                ...
                child: Center(
                  child: GestureDetector(
                    ...
                    child: Row(
                      children: [
                        Text(
                          authProvider.user?.username ?? 'Student',
                          style: TextStyle(
  ...
  Widget _buildHowItWorksSection() {
    final steps = [
      ...
      },
      {
        ...
        'description':
            'Schedule a viewing with the landlord and ask any questions about the property.',
      },
      {
        'number': '03',
        'icon': Icons.vpn_key,
        ...
        'description':
            'Pay securely through our platform and receive your booking confirmation instantly',
      },
      {
        'number': '04',
        'icon': Icons.home,
        'title': 'Move In',
        'description':
            'Sign your contract, collect your keys, and move into your new home',
      },
    ];
